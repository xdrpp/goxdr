...
type TEST_V1 interface {
	Test_null(context.Context, ) error
	Test_inc(context.Context, int32) (int32, error)
	Test_add(context.Context, int32, int32) (int32, error)
	Test_string(context.Context, BigString) (BigString, error)
}
...
func (p *xdrSrvProc_Test_inc) Do() {
	r, err := p.Srv.Test_inc(p.Ctx, *p.Arg)
	p.Res = &r
...
func (p *xdrSrvProc_Test_add) Do() {
	r, err := p.Srv.Test_add(p.Ctx, *p.Arg.a1, *p.Arg.a2)
	p.Res = &r
...
func (p *xdrSrvProc_Test_string) Do() {
	r, err := p.Srv.Test_string(p.Ctx, *p.Arg)
	p.Res = &r
...
func (c TEST_V1_Client) Test_null(ctx context.Context, ) error {
	var proc xdrProc_Test_null
	if err := c.Send.SendCall(ctx, &proc); err != nil {
		return err
	}
	return nil
}
func (c TEST_V1_Client) Test_inc(ctx context.Context, a1 int32) (r int32, _ error) {
...
func (c TEST_V1_Client) Test_add(ctx context.Context, a1 int32, a2 int32) (r int32, _ error) {
...
func (c TEST_V1_Client) Test_string(ctx context.Context, a1 BigString) (r BigString, _ error) {
